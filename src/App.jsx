...
import VistaEvaluaciones from "./page_docente/VistaEvaluaciones";
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoutes />}>
          ...
          <Route path="/docente" element={<LayoutDocente />}>
            ...
            <Route path="/docente/empresas/planilla/" element={<PlanillaEvaluacion />} />
            <Route path="/docente/empresas/:id/sprint" element={<VistaPlanificacion />} />
            <Route path="/docente/evaluaciones" element={<VistaEvaluaciones />} />
          </Route>
        </Route>
      </Routes>
    </Router>
